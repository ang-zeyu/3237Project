 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/simplelink/ble_sdk_2_02_06_07/examples/cc2650stk/sensortag/ccs/app/FlashOnly_OAD/configPkg/package/cfg/app_ble_pem3");
...
xdc_Ptr ti_sysbios_knl_Clock_TimerProxy_Object__create__S (
    ...
    xdc_runtime_Error_Block *__eb)
{
    return ti_sysbios_family_arm_cc26xx_Timer_Object__create__S(__obj, __osz, __aa, (const ti_sysbios_family_arm_cc26xx_Timer___ParamsPtr)__paramsPtr, sizeof(ti_sysbios_interfaces_ITimer_Params), __eb);
}
...
xdc_Ptr xdc_runtime_Memory_HeapProxy_Object__create__S (
    ...
    xdc_runtime_Error_Block *__eb)
{
    return xdc_runtime_HeapMin_Object__create__S(__obj, __osz, __aa, (const xdc_runtime_HeapMin___ParamsPtr)__paramsPtr, sizeof(xdc_runtime_IHeap_Params), __eb);
}
...
{
    return (void *)&xdc_runtime_HeapMin_Module__FXNS__C;
}
